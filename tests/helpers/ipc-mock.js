...
export function createMockElectronAPI() {
  ...
  const mockAPI = {
    ...
    stock: {
      getTree: createMockHandler('stock:getTree'),
      createFamilia: createMockHandler('stock:createFamilia'),
      updateFamilia: createMockHandler('stock:updateFamilia'),
      deleteFamilia: createMockHandler('stock:deleteFamilia'),
      createProducto: createMockHandler('stock:createProducto'),
      updateProducto: createMockHandler('stock:updateProducto'),
      deleteProducto: createMockHandler('stock:deleteProducto'),
      createArticulo: createMockHandler('stock:createArticulo'),
      updateArticulo: createMockHandler('stock:updateArticulo'),
      deleteArticulo: createMockHandler('stock:deleteArticulo'),
      setArticuloCantidad: createMockHandler('stock:setArticuloCantidad'),
      adjustArticuloCantidad: createMockHandler('stock:adjustArticuloCantidad'),
    },
    facturas: {
